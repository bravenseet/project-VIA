...
AI_MODEL    = "google/gemini-2.0-flash"   # any model slug from openrouter.ai/models
...
def add_categories(df: pd.DataFrame) -> pd.DataFrame:
    ...
    print(f"Categorising {total} rows using {MAX_WORKERS} parallel threads (OpenRouter/{AI_MODEL})...")
